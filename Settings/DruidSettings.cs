...
namespace Singular.Settings
{
    ...
    internal class DruidSettings : Styx.Helpers.Settings
    {
        ...
        [Description("Uses Dash to remove root")]
        ...
        // WotLK QC: Removed TreeOfLife Health/Count settings — in WotLK, Tree of Life is a permanent shapeshift form,
        // NOT a timed cooldown (Cata redesign). These thresholds are meaningless. No code reads them.
        // [Setting] [DefaultValue(80)] public int TreeOfLifeHealth { get; set; }
        // [Setting] [DefaultValue(3)] public int TreeOfLifeCount { get; set; }
